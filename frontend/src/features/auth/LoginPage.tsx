  ...
  return (
    <div className="flex min-h-screen bg-bg-base text-on-surface">
      <section className="relative hidden w-1/2 overflow-hidden border-r border-border-subtle lg:flex lg:items-center lg:justify-center">
        ...
        <div className="glass-panel relative z-10 mx-unit-8 max-w-lg rounded-xl p-unit-8 shadow-2xl">
          <div className="mb-unit-4 flex items-center gap-unit-2">
            <Terminal className="h-5 w-5 text-primary" />
            <span className="font-code text-label-caps uppercase tracking-widest text-primary">Engineering Excellence</span>
          </div>
          <blockquote className="mb-unit-6 text-heading-md font-semibold leading-tight tracking-tight text-on-surface">
          ...
          <div className="flex items-center gap-unit-4">
            <div className="flex h-10 w-10 items-center justify-center rounded-full border border-border-muted bg-surface-container-highest">
              <GraduationCap className="h-5 w-5 text-primary" />
            </div>
            <div>
              <p className="text-body-md font-semibold">Technical mastery</p>
              <p className="text-body-sm text-on-surface-variant">Built for serious interview prep</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="relative flex min-h-screen w-full flex-col justify-center overflow-hidden bg-surface-container-lowest px-gutter py-unit-12 md:px-unit-12 lg:w-1/2 xl:px-24">
        ...
        <div className="relative z-10 mb-unit-12 flex items-center gap-unit-2">
          ...
          <h1 className="text-heading-md font-bold tracking-tight">DevPrep AI</h1>
        </div>
        ...
        <div className="relative z-10 mx-auto w-full max-w-md lg:mx-0">
          ...
          <div className="relative mb-unit-8">
            ...
            <div className="relative flex justify-center">
              <span className="bg-surface-container-lowest px-unit-4 font-code text-label-caps uppercase tracking-widest text-on-surface-variant">Or continue with</span>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-unit-6">
            ...
            <div className="space-y-unit-2">
              <Label htmlFor="email" className="font-code text-label-caps uppercase tracking-widest text-on-surface-variant">Email Address</Label>
              <Input id="email" type="email" placeholder="dev@excellence.ai" className="h-12 rounded-lg border-border-muted bg-surface-container-lowest px-unit-4 text-body-md text-on-surface placeholder:text-outline-variant focus-visible:border-primary focus-visible:ring-primary/30 focus-visible:ring-offset-bg-base" {...register('email')} />
              {errors.email && <p className="text-body-sm text-error">{errors.email.message}</p>}
            </div>
            <div className="space-y-unit-2">
              <div className="flex items-center justify-between">
                <Label htmlFor="password" className="font-code text-label-caps uppercase tracking-widest text-on-surface-variant">Password</Label>
                <Link to="/forgot-password" className="text-body-sm text-primary transition-colors hover:text-primary-container">Forgot password?</Link>
              </div>
              <Input id="password" type="password" placeholder="••••••••" className="h-12 rounded-lg border-border-muted bg-surface-container-lowest px-unit-4 text-body-md text-on-surface placeholder:text-outline-variant focus-visible:border-primary focus-visible:ring-primary/30 focus-visible:ring-offset-bg-base" {...register('password')} />
              {errors.password && <p className="text-body-sm text-error">{errors.password.message}</p>}
            </div>
            <div className="flex items-center">
              <input id="remember" type="checkbox" className="h-4 w-4 rounded border-border-muted bg-surface-container-lowest text-primary focus:ring-primary" />
              <Label htmlFor="remember" className="ml-unit-3 text-body-sm text-on-surface-variant">Remember for 30 days</Label>
            </div>
            <Button type="submit" className="h-13 w-full rounded-lg bg-primary py-unit-4 text-heading-sm font-semibold text-on-primary shadow-lg shadow-primary/10 transition-all hover:brightness-110 active:scale-[0.98]" disabled={isSubmitting}>
