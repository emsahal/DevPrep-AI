...
export function RegisterPage() {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-bg-base text-on-surface">
      <section className="relative hidden w-1/2 flex-col justify-between overflow-hidden p-unit-10 lg:flex">
        ...
        <div className="relative z-10">
          ...
          <h1 className="mb-unit-6 max-w-lg text-4xl font-bold leading-tight tracking-tight xl:text-display-lg">
      ...
      <section className="relative flex h-screen w-full items-center justify-center overflow-hidden bg-surface-container-lowest p-unit-4 lg:w-1/2">
        ...
        <div className="relative z-10 w-full max-w-md space-y-unit-4">
          ...
          <div className="grid grid-cols-2 gap-unit-3">
            <button type="button" className="flex items-center justify-center gap-unit-2 rounded-lg border border-border-subtle bg-surface-raised px-unit-4 py-unit-2 text-body-sm font-semibold transition-all hover:bg-surface-container active:scale-95">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-unit-3">
            {error && (
            ...
            <div className="space-y-unit-1">
              ...
              <Input id="name" placeholder="Engineering Architect" className="h-11 rounded-lg border-border-subtle bg-surface-raised px-unit-4 text-on-surface placeholder:text-outline-variant focus-visible:border-primary focus-visible:ring-primary/30 focus-visible:ring-offset-bg-base" {...register('name')} />
            ...
            <div className="space-y-unit-1">
              ...
              <Input id="email" type="email" placeholder="dev@prep-ai.io" className="h-11 rounded-lg border-border-subtle bg-surface-raised px-unit-4 text-on-surface placeholder:text-outline-variant focus-visible:border-primary focus-visible:ring-primary/30 focus-visible:ring-offset-bg-base" {...register('email')} />
            ...
            <div className="space-y-unit-1">
              ...
              <Input id="password" type="password" placeholder="••••••••" className="h-11 rounded-lg border-border-subtle bg-surface-raised px-unit-4 text-on-surface placeholder:text-outline-variant focus-visible:border-primary focus-visible:ring-primary/30 focus-visible:ring-offset-bg-base" {...register('password')} />
            ...
            <div className="space-y-unit-1">
              ...
              <Input id="confirmPassword" type="password" placeholder="••••••••" className="h-11 rounded-lg border-border-subtle bg-surface-raised px-unit-4 text-on-surface placeholder:text-outline-variant focus-visible:border-primary focus-visible:ring-primary/30 focus-visible:ring-offset-bg-base" {...register('confirmPassword')} />
              {errors.confirmPassword && <p className="text-body-sm text-error">{errors.confirmPassword.message}</p>}
            </div>
            <Button type="submit" className="mt-unit-2 h-12 w-full rounded-lg bg-primary py-unit-3 text-heading-sm font-semibold text-on-primary shadow-lg shadow-primary/10 transition-all hover:brightness-110 active:scale-[0.98]" disabled={isSubmitting}>
