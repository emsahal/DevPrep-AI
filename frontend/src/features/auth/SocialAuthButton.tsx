...
function GoogleIcon() {
  return <span className="text-sm font-bold">G</span>
}
...
export function SocialAuthButton({ provider, label, className }: SocialAuthButtonProps) {
  const startOAuth = () => {
    window.location.href = `${apiBaseUrl}/auth/${provider}/start`
  }
