  ...
  return (
    <div className="min-h-[calc(100vh-64px)] flex flex-col">
      ...
      <section className="px-6 py-20 max-w-5xl mx-auto w-full">
        <div className="bento-card ai-glow-border p-8 md:p-12 flex flex-col md:flex-row items-center gap-8 md:gap-12">
          <AnimateOnScroll className="flex-1">
            <div className="w-14 h-14 rounded-2xl flex items-center justify-center mb-4"
                 style={{ background: 'rgba(76,215,246,0.12)' }}>
              <span className="material-symbols-outlined text-[28px]" style={{ color: 'var(--color-secondary)', fontVariationSettings: "'FILL' 1" }}>data_object</span>
            </div>
            <h2 className="text-2xl font-bold mb-3" style={{ color: 'var(--color-on-surface)' }}>Coding Practice</h2>
            <p className="text-sm mb-5 leading-relaxed" style={{ color: 'var(--color-on-surface-variant)' }}>
              Solve real DSA problems with AI-powered evaluation. Write code, get instant feedback on correctness,
              edge cases, time complexity, and space complexity. Track your solved questions and improve daily.
            </p>
          ...
          <AnimateOnScroll delay={150} className="flex-shrink-0">
            <div className="grid grid-cols-2 gap-3">
              {[
                { label: 'Questions', value: '150+', color: 'var(--color-secondary)' },
                { label: 'Levels', value: '5', color: 'var(--color-primary)' },
                { label: 'Languages', value: '2', color: 'var(--color-tertiary)' },
                { label: 'AI Checked', value: 'Instant', color: 'var(--color-success)' },
              ].map((s) => (
                <div key={s.label} className="rounded-xl p-4 text-center min-w-[100px]"
      ...
      <section className="px-6 py-20 max-w-5xl mx-auto w-full">
        <div className="bento-card ai-glow-border p-8 md:p-12 flex flex-col md:flex-row items-center gap-8 md:gap-12">
          <AnimateOnScroll className="flex-1" delay={100}>
            <div className="w-14 h-14 rounded-2xl flex items-center justify-center mb-4"
                 style={{ background: 'rgba(208,188,255,0.12)' }}>
              <span className="material-symbols-outlined text-[28px]" style={{ color: 'var(--color-primary)', fontVariationSettings: "'FILL' 1" }}>description</span>
            </div>
            <h2 className="text-2xl font-bold mb-3" style={{ color: 'var(--color-on-surface)' }}>Resume Optimizer</h2>
            <p className="text-sm mb-5 leading-relaxed" style={{ color: 'var(--color-on-surface-variant)' }}>
              Upload your resume and a job description to get an ATS-optimized resume, professional cover letter,
              and detailed gap analysis. Our AI rewrites your content while keeping every fact truthful.
            </p>
          ...
          <AnimateOnScroll delay={250} className="flex-shrink-0">
            <div className="grid grid-cols-2 gap-3">
              {[
                { label: 'ATS Score', value: 'AI', color: 'var(--color-primary)' },
                { label: 'Templates', value: '5', color: 'var(--color-secondary)' },
                { label: 'Cover Letter', value: 'Auto', color: 'var(--color-tertiary)' },
                { label: 'Format', value: 'DOCX', color: 'var(--color-success)' },
              ].map((s) => (
                <div key={s.label} className="rounded-xl p-4 text-center min-w-[100px]"
                     style={{ background: 'var(--color-surface-container)' }}>
                  <div className="text-lg font-extrabold" style={{ color: s.color }}>{s.value}</div>
      ...
      <section className="px-6 py-20 max-w-5xl mx-auto w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <AnimateOnScroll>
            <div className="bento-card p-7 border" style={{ borderColor: 'var(--color-border-muted)' }}>
          ...
          <AnimateOnScroll delay={150}>
            <div className="bento-card p-7 ai-glow-border">
              <div className="flex items-center gap-3 mb-5">
      ...
      <section className="px-6 py-20 max-w-5xl mx-auto w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          <AnimateOnScroll className="md:col-span-2">
            <div className="bento-card p-7 flex flex-col items-start ai-glow-border">
          ...
          <AnimateOnScroll delay={150} className="flex flex-col gap-4">
      ...
      <section className="px-6 py-24 max-w-4xl mx-auto w-full text-center">
        <AnimateOnScroll>
          <div className="bento-card ai-glow-border p-14 relative overflow-hidden">
