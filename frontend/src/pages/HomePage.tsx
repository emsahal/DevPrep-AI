  ...
  return (
    <div className="flex justify-center py-6">
      <svg width="24" height="48" viewBox="0 0 24 48" fill="none">
        <path d="M12 0V36" stroke="var(--color-primary)" strokeWidth="2" strokeDasharray="4 4" opacity="0.4" />
        <polygon points="12,48 8,40 16,40" fill="var(--color-primary)" opacity="0.6" />
      </svg>
    </div>
  )
}
  ...
  return (
    <div className="min-h-[calc(100vh-64px)] flex flex-col">
      ...
      <section className="relative flex-1 flex flex-col items-center justify-center text-center px-6 py-28 overflow-hidden">
        ...
        <svg className="absolute top-20 left-12 w-20 h-20 opacity-15" viewBox="0 0 80 80" fill="none">
          <circle cx="40" cy="40" r="38" stroke="var(--color-secondary)" strokeWidth="1.5" strokeDasharray="6 5" fill="none" />
          <circle cx="40" cy="40" r="22" stroke="var(--color-primary)" strokeWidth="1" opacity="0.6" fill="none" />
        </svg>
        <svg className="absolute bottom-32 right-16 w-16 h-16 opacity-15" viewBox="0 0 64 64" fill="none">
          <path d="M32 4L39.6 22.4L58 24L42.8 37.6L48 56L32 44L16 56L21.2 37.6L6 24L24.4 22.4L32 4Z" fill="var(--color-primary)" />
        </svg>
      ...
      <section className="px-6 py-24 max-w-4xl mx-auto w-full text-center">
        <div className="bento-card ai-glow-border p-14 animate-fade-up relative overflow-hidden">
          <svg className="absolute top-0 right-0 w-48 h-48 opacity-10 pointer-events-none" viewBox="0 0 160 160" fill="none">
            <circle cx="120" cy="40" r="90" stroke="var(--color-primary)" strokeWidth="1" strokeDasharray="8 6" fill="none" />
            <circle cx="120" cy="40" r="55" stroke="var(--color-secondary)" strokeWidth="0.5" fill="none" />
          </svg>
          <div className="absolute bottom-0 left-0 w-40 h-40 opacity-10 pointer-events-none">
            <svg viewBox="0 0 80 80" fill="none">
              <path d="M40 8L48 28L68 30L52 44L58 64L40 52L22 64L28 44L12 30L32 28L40 8Z" fill="var(--color-primary)" />
            </svg>
          </div>
