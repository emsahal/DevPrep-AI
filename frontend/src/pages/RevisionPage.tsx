...
export function RevisionPage() {
  ...
  return (
    <>
      <SEOHead
        title="Revision Hub"
        description="Spaced-repetition topic revision hub to maximize long-term retention for developer interviews."
      />
        ...
        {!isAuthenticated && (
          <div className="p-4 rounded-xl mb-6 flex items-center justify-between gap-4 animate-fade-up" style={{ background: 'var(--color-primary-container)', border: '1px solid var(--color-primary)' }}>
            <div className="flex items-center gap-2">
              <span className="material-symbols-outlined text-[20px]" style={{ color: 'var(--color-primary)' }}>event_repeat</span>
              <p className="text-xs font-semibold" style={{ color: 'var(--color-on-primary-container)' }}>
                Guest Revision Trial: Previewing revision schedule. Sign in to save custom intervals & streak stats.
              </p>
            </div>
